 ...
 */
public class AfternoonTeaFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "AfternoonTeaFragment";
...
//        webServiceConnection = new WebServiceConnection();
    ...
    private void initCount() {
        DecimalFormat nf = new DecimalFormat("0.00");
        dating_moisture.setText("午後點心總熱量：");
