...
//    private static final String TAG = "BluetoothService";
    ...
    private static final String NAME = "XenonBluetooth";
...
//    private static final UUID MY_UUID = UUID.fromString("00000003-0000-1000-8000-00805F9B34FB");
    ...
    private class AcceptThread extends Thread {
        ...
        private BluetoothServerSocket SetServerSocket() {
            BluetoothServerSocket tmp = null;
            // Create a new listening server socket
            try {
                if (D) {
                    Log.d(TAG, "try accept Thread()");
                }
        ...
        public AcceptThread() {
            while (mmServerSocket == null) {
                mmServerSocket = SetServerSocket();
            }
        }

        public void run() {
            if (D) {
                Log.d(TAG, "BEGIN accept Thread" + this);
            }
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    if (D) {
                        Log.d(TAG, "after try accept:" + socket.toString());
                    }
                } catch (IOException e) {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MainService.MESSAGE_READ, bytes, -1, rcvData)
                            .sendToTarget();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(MainService.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
