...
//    private static final String TAG = "BluetoothChatService";
    private static String TAG = BluetoothChatService.class.getSimpleName();
    ...
    private static final UUID MY_UUID_INSECURE = UUID.fromString("1ac9d3f0-29f0-11e1-9314-0800200c9a66");
     ...
     */
    public BluetoothChatService(GetBlueToothDeviceDataService mainui, Handler handler) {
