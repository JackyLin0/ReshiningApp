 ...
 */
public class BTAsVoice2GSConnService {
    // Debugging
    //    private static final String TAG = "BTAsVoice2GSConnService";
    private static String TAG = BTAsVoice2GSConnService.class.getSimpleName();

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "BTAV2Secure";
    private static final String NAME_INSECURE = "BTAV2Insecure";
    ...
    public BTAsVoice2GSConnService(GetBlueToothDeviceDataService mainui, Handler handler) {
    ...
    public synchronized void start() {
        Log.d(TAG, "BTAsVoice2GSConnService.start()");
    ...
    public synchronized void connected(
        ...
        Log.d(TAG, "BTAsVoice2GSConnService.connected()");
    ...
    private void connectionFailed() {
        ...
        BTAsVoice2GSConnService.this.start();
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(GetBlueToothDeviceDataService.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString("glucose", "藍芽連線中斷");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BTAsVoice2GSConnService.this) {
                        switch (mState) {
                            case STATE_LISTEN:
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.e(TAG, "unable to connect() " + mSocketType + " socket during connection failure", e);
                // Close the socket
                try {
                    mmSocket.close();
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    for (i = 0; i < bytes; i++) {
                        Log.i(TAG, "echo received: buffer[" + i + "]=" + Integer.toHexString(buffer[i]));
                        outbuf[i + 1] = buffer[i];
                    }
