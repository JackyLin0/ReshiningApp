 ...
 */
public class ShowGCMFragment extends DialogFragment {
    private static final String TAG = "ShowGCMFragment";

    private EditText add_gcm_time, add_gcm_name, add_gcm_body;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.dialogfragment_show_gcm, container, false);
    ...
    private void initView() {
        add_gcm_time = (EditText) rootView.findViewById(R.id.add_gcm_time);
    ...
    private void initHandler() {
        ...
        if (getArguments().getString("GCM_time") != null) {
            add_gcm_time.setText(getArguments().getString("GCM_time"));
        }
        if (getArguments().getString("GCM_title") != null) {
            add_gcm_name.setText(getArguments().getString("GCM_title"));
            add_gcm_name.setTextColor(getResources().getColor(R.color.defTextColor));
            add_gcm_name.setTextSize(18);
        } else {
            add_gcm_name.setHint(getString(R.string.data_note_no));
        }
        if (getArguments().getString("GCM_body") != null) {
            add_gcm_body.setText(getArguments().getString("GCM_body"));
            add_gcm_body.setTextColor(getResources().getColor(R.color.defTextColor));
            add_gcm_body.setTextSize(18);
        } else {
            add_gcm_body.setHint(getString(R.string.data_note_no));
        }
    }
    ...
    protected class pushmessage extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            if (!isCancelled()) {
                try {
                    UserDataDAO userAdapter = new UserDataDAO(getContext());
                    List<UserData> userList = userAdapter.getuserdata();
