 ...
 */
public class MySystemSettingsFragment  extends DrawerFrameworkMainFragment {
    private static final String TAG = MySystemSettingsFragment.class.getSimpleName();
    ...
    protected void onSetToolbar(Toolbar toolbar) {
        ...
        toolbar.setTitle(getString(R.string.fragment_mysystemsettings));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_mysystemsettings, container, false);
    ...
    private void initView() {
        rootView.findViewById(R.id.password_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment dialogFragment = new SettingPassWordFragment();
                //                dialogFragment.setArguments(bundle);
                dialogFragment.setStyle(DialogFragment.STYLE_NORMAL, R.style.PageTransparent);
                dialogFragment.show(getActivity().getSupportFragmentManager(), "SettingPassWordFragment");
        ...
        rootView.findViewById(R.id.gcm_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment dialogFragment = new SettingGCMFragment();
                //                dialogFragment.setArguments(bundle);
                dialogFragment.setStyle(DialogFragment.STYLE_NORMAL, R.style.PageTransparent);
                dialogFragment.show(getActivity().getSupportFragmentManager(), "SettingGCMFragment");

            }
        });

        rootView.findViewById(R.id.gcm_send_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment dialogFragment = new SendGCMFragment();
                //                dialogFragment.setArguments(bundle);
                dialogFragment.setStyle(DialogFragment.STYLE_NORMAL, R.style.PageTransparent);
                dialogFragment.show(getActivity().getSupportFragmentManager(), "SendGCMFragment");
